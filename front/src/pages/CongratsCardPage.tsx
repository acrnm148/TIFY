      ...
      <div className="congrats-card-page-containger">
        <div className="congrats-card-page-containger-border">
          <div className="congrats-card-page-left">
            <GiftLoadingIcon achieved={state.selectGift.achieved} />
            <div className="gift-info">
              <div className="gift-img-box-con">
                <img
                  className="gift-img-box"
                  src={state.selectGift.img}
                  alt=""
                />
              </div>
...
const GiftLoadingIcon = memo(function GiftLoadingIcon(props: {
  achieved: number;
}) {
  const donut = useRef<HTMLDivElement>(null);
  const totalMinwon = props.achieved;
  useEffect(() => {
  ...
  return (
    <div className="gift-loading">
      ...
      <div className="donut" ref={donut}>
        ...
        >
          <path
            d="M93.4773 133.323C93.612 119.556 90.1215 108.36 85.6815 108.316C81.2412 108.273 77.5326 119.399 77.3982 133.166C77.2635 146.934 80.754 158.13 85.194 158.174C89.6343 158.217 93.3429 147.091 93.4773 133.323Z"
            fill="white"
            fillOpacity="0.01"
          />
          <path
            d="M67.7257 130.196C75.283 118.687 78.4003 107.381 74.6887 104.944C70.9768 102.507 61.8415 109.861 54.2845 121.37C46.7272 132.879 43.6099 144.185 47.3215 146.622C51.0334 149.06 60.1684 141.705 67.7257 130.196Z"
            fill="white"
            fillOpacity="0.01"
          />
          <path
            d="M47.7224 113.684C60.3026 108.088 69.0377 100.263 67.2329 96.2057C65.4284 92.1485 53.7674 93.3959 41.1872 98.9918C28.6071 104.587 19.8719 112.413 21.6765 116.47C23.4812 120.527 35.1423 119.28 47.7224 113.684Z"
            fill="white"
            fillOpacity="0.01"
          />
          <path
            d="M106.76 46.8764C110.77 33.7046 110.576 21.9786 106.328 20.6855C102.08 19.3925 95.3866 29.0221 91.3771 42.1938C87.3679 55.3655 87.5611 67.0916 91.8091 68.3846C96.0571 69.6776 102.751 60.0482 106.76 46.8764Z"
            fill="white"
            fillOpacity="0.01"
          />
          <path
            d="M125.639 64.6743C136.132 55.7598 142.308 45.7899 139.433 42.406C136.558 39.022 125.721 43.5054 115.228 52.4196C104.735 61.3341 98.5598 71.304 101.435 74.688C104.31 78.072 115.146 73.5888 125.639 64.6743Z"
            fill="white"
            fillOpacity="0.01"
          />
          <path
            d="M131.881 89.8603C145.528 88.0345 156.113 82.9867 155.524 78.5854C154.936 74.1844 143.395 72.0967 129.748 73.9222C116.102 75.748 105.516 80.7958 106.105 85.1971C106.694 89.5981 118.234 91.6861 131.881 89.8603Z"
            fill="white"
            fillOpacity="0.01"
          />
          <path
            d="M149.487 117.728C151.371 113.707 142.792 105.711 130.324 99.8683C117.857 94.0255 106.223 92.5486 104.339 96.5692C102.454 100.59 111.033 108.586 123.501 114.429C135.968 120.271 147.602 121.749 149.487 117.728Z"
            fill="white"
            fillOpacity="0.01"
          />
          <path
            d="M123.261 147.395C127.02 145.031 124.126 133.666 116.797 122.01C109.469 110.354 100.48 102.822 96.7211 105.185C92.9621 107.548 95.8559 118.914 103.185 130.569C110.513 142.225 119.502 149.758 123.261 147.395Z"
            fill="white"
            fillOpacity="0.01"
          />
          <path
          ...
          />
          <path
            d="M65.7226 84.8283C66.3982 80.4396 55.9141 75.1839 42.3061 73.0893C28.6977 70.9947 17.1185 72.8547 16.443 77.2434C15.7675 81.6321 26.2516 86.8875 39.8598 88.9821C53.4679 91.0767 65.0473 89.2167 65.7226 84.8283Z"
            stroke="white"
            strokeMiterlimit="10"
          />
          <path
            d="M70.6083 74.3734C73.5489 71.0464 67.5693 60.9577 57.2526 51.8398C46.9359 42.722 36.1887 38.0277 33.2482 41.3549C30.3077 44.6821 36.2873 54.7708 46.6041 63.8887C56.9208 73.0066 67.668 77.7007 70.6083 74.3734Z"
            stroke="white"
            strokeMiterlimit="10"
          />
          <path
            d="M80.3387 68.2631C84.6113 67.0541 85.0359 55.334 81.2871 42.0858C77.5383 28.8375 71.0355 19.0778 66.7629 20.2868C62.4903 21.4958 62.0658 33.2158 65.8146 46.4641C69.5634 59.7121 76.0661 69.4721 80.3387 68.2631Z"
            stroke="white"
            strokeMiterlimit="10"
          />
          <path
      ...
      <p>선물이 {props.achieved}% 채워지고있어요!</p>
    </div>
  );
});
