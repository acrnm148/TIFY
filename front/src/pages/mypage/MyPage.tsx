...
export function MyPage() {
  ...
  return (
    <div className="mypage-div">
      <div className="side-div">
        ...
        <div className="side-menu-div ">
          <NavLink
            to="mywish"
            className={
              tapId == 'mywish' ? 'active-menu side-menu' : 'side-menu'
            }
          >
      ...
      <Outlet context={{ Setname, SetNickName }}></Outlet>
    </div>
  );
}
